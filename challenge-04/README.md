...
*/
carro.mudaCor = function(carroCor){ carro.cor = carroCor } 
...
carro.addPessoas = function(numPessoas){ 
  ...
  if(carro.quantidadePessoas >= carro.assentos){
    ...
    if(assentosRestantes != 1){
        assentosRestantes = (carro.assentos - carro.quantidadePessoas);
        return " Só cabem mais " + assentosRestantes + " pessoas!";
      }
      else{
        assentosRestantes = (carro.assentos - carro.quantidadePessoas);
        return " Só cabe mais " + assentosRestantes + " pessoa!";
      }
  }
